...
function initMap() {
    ...
    /* marker1 = L.marker([39.907809, 32.764051]).addTo(mymap);
    marker2 = L.marker([39.908626, 32.786003]).addTo(mymap); */
...
function calculateDistance() { //by using the haversine formula
    ...
    if (i < 2) {
        for (i = 1; i < markers.length; i++) {
            /* console.log("if1 lat: " + markers[i - 1].getLatLng());
            console.log("if2 lng: " + markers[i].getLatLng());
            console.log("if3 length: " + markers.length); */
            d = markers[i].getLatLng().distanceTo(markers[i - 1].getLatLng());
            path_length += d / 1000;
            /* console.log("if4 d: " + d);
            console.log("if4 path length: " + path_length); */
        }
        $("#total-length").append('Total Length: ' + path_length + ' km');

    } else {
        /* console.log("else1 lat: " + markers[i - 1].getLatLng());
        console.log("else2 lng: " + markers[i].getLatLng());
        console.log("else3 length: " + markers.length); */
        d = markers[i].getLatLng().distanceTo(markers[i - 1].getLatLng());
        console.log(d);
        path_length += d / 1000;
        ...
        /* console.log("else4 d: " + d);
        console.log("else4 path length: " + path_length); */
        i++;
        $("#total-length").append('Total Length: ' + path_length + ' km');
...
/* console.log(marker1.getLatLng().distanceTo(marker2.getLatLng())); */